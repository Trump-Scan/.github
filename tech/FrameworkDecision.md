...
| **중복 제거** | Python | Pure Python | ML 라이브러리 직접 활용 |
| **피드 생성** | Node.js | Pure Node.js | 타입 공유, 빠른 구현 |
...
## 4. 피드 생성 레이어: Pure Node.js

### 4.1 선택 이유

#### **왜 Pure Node.js인가?**
- **단순한 변환 작업**: 분석 데이터 → 피드 포맷
- **프레임워크 불필요**: 단일 목적 워커
- **API와 타입 공유**: TypeScript 인터페이스 재사용
- **비동기 I/O 최적**: Node.js의 강점 활용
